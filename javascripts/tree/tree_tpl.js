...
//	'target'  : '_blank',		// name of the frame links will be opened in	
	'target'  : 'main_frame',	// name of the frame links will be opened in
	...
	'icon_0'  : 'icons/pagenew.gif', // leaf icon normal
	'icon_4'  : 'icons/pagenew_sel.gif', // leaf icon selected
	'icon_8'  : 'icons/page.gif', // leaf icon opened
	'icon_12' : 'icons/pagenew_sel.gif', // leaf icon selected
